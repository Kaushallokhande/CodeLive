    ...
    >
      ...
      <Box sx={{ position: "absolute", top: 20, right: 20, display: "flex", gap: 1 }}>
        <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
          <Button
            variant="contained"
            sx={{ bgcolor: darkMode ? "#333" : "black", color: "white", textTransform: "none" }}
            startIcon={<Group />}
      ...
      {showCreateForm && (
        ...
        >
          ...
          <TextField
            ...
            sx={{ bgcolor: darkMode ? "#333" : "white", borderRadius: 1 }}
          />
          <FormControlLabel
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button
              fullWidth
              variant="contained"
              sx={{ mt: 2, bgcolor: darkMode ? "#444" : "black", color: "white", textTransform: "none" }}
          ...
          <Button
            sx={{ mt: 2, color: darkMode ? "#bbb" : "black" }}
            startIcon={<Close />}
